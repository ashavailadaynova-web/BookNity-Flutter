...
class KomikFilter extends StatefulWidget {
  const KomikFilter({Key? key}) : super(key: key);

  @override
  State<KomikFilter> createState() => _KomikFilter();
}

class _KomikFilter extends State<KomikFilter> {
  double _currentSliderValue = 0;

  // State untuk mencatat rating mana yang dipilih (aktif)
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          // Konten Pilihan Filter (Scrollable)
          Expanded(
            child: ListView(
          ...
          // Tombol Aksi di bagian bawah Filter
          const Divider(height: 1, color: Color(0xFFEFEFEF)),
          Padding(
            padding: const EdgeInsets.all(20.0),
            child: Row(
                ...
                Expanded(
                  ...
                  child: ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                      backgroundColor: const Color(0xFF4A352F), // Cokelat gelap tombol Terapkan
  ...
  // Helper Widget Judul Section Filter
  Widget _buildFilterTitle(String title) {
    return Text(
      title,
      style: GoogleFonts.montserrat(
        color: const Color(0xFF801A3B), // Warna marun/magenta gelap khas label filter
        fontWeight: FontWeight.w700,
        fontSize: 12,
        letterSpacing: 0.8,
      ),
  ...
  // Helper Widget Chip untuk Section URUTKAN
  ...
  // Helper Widget Chip untuk Kategori Buku
  ...
  // Helper Widget Lingkaran Rating Bintang dengan State Aktif

...
class SeniHobiFilterBottomSheet extends StatefulWidget {
  const SeniHobiFilterBottomSheet({Key? key}) : super(key: key);

  @override
  State<SeniHobiFilterBottomSheet> createState() => _SeniHobiFilterBottomSheetState();
}

class _SeniHobiFilterBottomSheetState extends State<SeniHobiFilterBottomSheet> {
                ...
                Row(
                  ...
                  children: [
                    ...
                    Text(
                      ...
                      style: GoogleFonts.montserrat(fontSize: 10, color: const Color(0xFF8C8C8C), fontWeight: FontWeight.w500),
                    ),
                  ],
                ),
                const SizedBox(height: 10),
              ...
              children: [
                Expanded(
                  child: TextButton(
                    ...
                    child: Text('Ulangi', style: GoogleFonts.montserrat(color: Colors.black, fontWeight: FontWeight.w700)),
                  ),
                ),
                ...
                Expanded(
                  ...
                  child: ElevatedButton(
                    ...
                    child: Text('Terapkan', style: GoogleFonts.montserrat(color: Colors.white, fontWeight: FontWeight.w700)),
                  ),
                ),
              ],
            ),
  ...
  Widget _buildFilterTitle(String title) {
    return Text(title, style: GoogleFonts.montserrat(color: const Color(0xFF801A3B), fontWeight: FontWeight.w700, fontSize: 12));
  }
  ...
  Widget _buildFilterChip(String label, {required bool isSelected}) {
    return Container(
      decoration: BoxDecoration(
        ...
        border: Border.all(color: const Color(0xFFD3C2B5)),
      ),
      padding: const EdgeInsets.symmetric(horizontal: 22, vertical: 10),
      child: Text(label, style: GoogleFonts.montserrat(fontSize: 13, fontWeight: isSelected ? FontWeight.w700 : FontWeight.w500)),
    );
  }

  Widget _buildCategoryChip(String label, {required bool isActive}) {
    return Container(
      decoration: BoxDecoration(color: isActive ? const Color(0xFFEFE8DE) : Colors.transparent, borderRadius: BorderRadius.circular(20)),
      padding: const EdgeInsets.symmetric(horizontal: 18, vertical: 10),
      child: Text(label, style: GoogleFonts.montserrat(fontSize: 13, fontWeight: FontWeight.w600)),
    );
  }
      ...
      child: Column(
        children: [
          Container(
            width: 50, height: 50,
            decoration: BoxDecoration(
              color: const Color(0xFFEFE8DE), shape: BoxShape.circle,

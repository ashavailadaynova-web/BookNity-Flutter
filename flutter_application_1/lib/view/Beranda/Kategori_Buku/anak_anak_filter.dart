...
class AnakAnakFilterBottomSheet extends StatefulWidget {
  const AnakAnakFilterBottomSheet({Key? key}) : super(key: key);

  @override
  State<AnakAnakFilterBottomSheet> createState() =>
      _AnakAnakFilterBottomSheetState();
}

class _AnakAnakFilterBottomSheetState extends State<AnakAnakFilterBottomSheet> {
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              ...
              border: isSelected
                  ? Border.all(color: const Color(0xFFC76E2E), width: 2)
                  : null,
            ),

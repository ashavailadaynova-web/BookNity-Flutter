...
class SelfHelpFilterBottomSheet extends StatefulWidget {
  const SelfHelpFilterBottomSheet({Key? key}) : super(key: key);

  @override
  State<SelfHelpFilterBottomSheet> createState() => _SelfHelpFilterBottomSheetState();
}

class _SelfHelpFilterBottomSheetState extends State<SelfHelpFilterBottomSheet> {

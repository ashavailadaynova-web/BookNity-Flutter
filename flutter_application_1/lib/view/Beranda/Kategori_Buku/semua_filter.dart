...
class SemuaFilterBottomSheet extends StatefulWidget {
  const SemuaFilterBottomSheet({Key? key}) : super(key: key);

  @override
  State<SemuaFilterBottomSheet> createState() => _SemuaFilterBottomSheetState();
}

class _SemuaFilterBottomSheetState extends State<SemuaFilterBottomSheet> {
  double _currentSliderValue = 0;
  String _selectedRating = '1+';
  bool _isInStockOnly = false; // Status untuk switch "In Stock Only"
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Switch(
                        value: _isInStockOnly,
                        activeColor: const Color(0xFFC76E2E),
                        activeTrackColor: const Color(0xFFEFE8DE),
                        inactiveThumbColor: Colors.grey.shade400,
                        inactiveTrackColor: Colors.grey.shade200,
                        onChanged: (bool value) {
                          setState(() {
                            _isInStockOnly = value;
                          });
                        },
                      ),
                    ],
